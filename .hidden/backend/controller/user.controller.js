...
export const updateUser = async(req, res) => {
    ...
    try {
        await query("UPDATE tb_user SET nama=?, email=?, password=?, nik=?, alamat=?, authority=?, foto_profile=? WHERE id_user=?", 
            [nama, email, password, nik, alamat, authority, foto_profile, id_user]
        );
